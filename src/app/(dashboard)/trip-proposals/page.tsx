...
export default function TripProposalsPage() {
  ...
  const createProposal = async (event: React.FormEvent) => {
    ...
    if (!travel.start_date || !travel.end_date)
      return toast.error('Travel dates are required');
    if (
      new Date(`${travel.end_date}T00:00:00`) <
      new Date(`${travel.start_date}T00:00:00`)
    ) {
        ...
        <DialogContent className="flex h-[min(94vh,920px)] w-[calc(100vw-24px)] max-w-[1380px] flex-col gap-0 overflow-hidden rounded-2xl p-0 sm:w-[calc(100vw-40px)]">
          <DialogHeader className="shrink-0 border-b bg-white px-6 py-4 sm:px-7">
            <DialogTitle className="flex items-center gap-2 text-xl font-bold text-slate-900">
              <Sparkles className="h-5 w-5 text-emerald-500" /> Create Trip
              Proposal
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="shrink-0 border-b bg-white px-6 py-3 sm:px-7">
            <div className="mx-auto flex max-w-4xl items-center justify-between gap-2 text-xs font-semibold text-slate-500">
              {[
                ...
                >
                  <div
                    className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-xs font-bold ${index === 0 ? 'bg-emerald-500 text-white' : 'bg-slate-200 text-slate-600'}`}
                  >
                    {number}
                  </div>
          ...
          >
            <div className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto bg-slate-50/60 p-4 sm:p-6">
              <div className="grid min-w-0 grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1.45fr)_minmax(360px,0.9fr)]">
                    ...
                    <div className="grid min-w-0 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="mt-1.5 h-10 w-full min-w-0 rounded-xl border bg-white px-3 text-xs outline-none focus:ring-2 focus:ring-emerald-200"
                        >
                      ...
                      <div>
                        ...
                        <Input
                          readOnly
                          value={duration(travel.start_date, travel.end_date)}
                  ...
                  <section className="min-w-0 rounded-2xl border bg-white p-4 shadow-sm sm:p-5">
                    ...
                    <div className="space-y-3">
                      {travel.itinerary.map((day, index) => (
                        <div
                          key={`day-${index}`}
                          className="grid min-w-0 gap-2 sm:grid-cols-[56px_minmax(0,1fr)_minmax(0,1.8fr)_36px] sm:items-center"
                        >
                          ...
                          <Input
                            ...
                            placeholder="Activities, transfers and notes"
                          />
                          <Button
                            type="button"
                            variant="ghost"
                          ...
                          {travel[key].map((value, index) => (
                            ...
                            >
                              <Input
                                value={value}
                                onChange={(event) =>
                                  updateList(key, index, event.target.value)
                                }
                                placeholder={
                                  key === 'inclusions'
                                    ? 'Daily breakfast'
                ...
                <div className="min-w-0 space-y-4">
                  <section className="min-w-0 rounded-2xl border bg-white p-4 shadow-sm sm:p-5">
                    ...
                    <div className="hidden grid-cols-[minmax(0,1fr)_60px_112px_100px_32px] gap-2 border-b pb-2 text-[10px] font-bold text-slate-400 uppercase sm:grid">
                      <span>Service</span>
                      <span>Qty</span>
                    ...
                    <div className="space-y-2 pt-2">
                      {items.map((item, index) => {
                        ...
                        return (
                          <div
                            key={`service-${index}`}
                            className="grid min-w-0 gap-2 rounded-xl border bg-slate-50/60 p-2 sm:grid-cols-[minmax(0,1fr)_60px_112px_100px_32px] sm:items-center sm:border-0 sm:bg-transparent sm:p-0"
                          >
                            <div className="min-w-0">
                              <Label className="mb-1 block text-[10px] text-slate-400 sm:hidden">
                                Service
                              </Label>
                              <div className="flex min-w-0 items-center gap-2">
                                <select
                                  ...
                                  className="h-10 w-28 shrink-0 rounded-xl border bg-white px-2 text-[11px]"
                                >
                                  <option>Hotel</option>
                            ...
                            <div className="flex h-10 items-center justify-between rounded-xl border bg-white px-3 text-xs font-semibold sm:border-0 sm:bg-transparent sm:px-0">
                  ...
                  <section className="min-w-0 rounded-2xl border bg-white p-4 shadow-sm sm:p-5">
                    ...
                    <div className="space-y-3 text-xs">
                      ...
                      <div className="flex justify-between border-t pt-3 text-base">
                        <span className="font-bold">Total Package Price</span>
                  ...
                  <section className="min-w-0 rounded-2xl border bg-white p-4 shadow-sm sm:p-5">
                    ...
                    <textarea
                      ...
                      placeholder="We are happy to customize this itinerary as per your preferences."
                      className="mt-2 min-h-28 w-full resize-y rounded-xl border bg-white p-3 text-xs outline-none focus:ring-2 focus:ring-emerald-200"
                    />
                  </section>
                </div>
              </div>
              ...
              <div className="flex w-full flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Button
                    ...
                    onClick={() =>
                      toast.info(
                        'Draft saving uses the same quotation workflow.'
                      )
                    }
                    className="rounded-xl"
                  >
                  ...
                  >
                    ...
                    {saving ? 'Saving...' : 'Preview & Send Proposal'}
                  </Button>
                </div>
              </div>
            </DialogFooter>
