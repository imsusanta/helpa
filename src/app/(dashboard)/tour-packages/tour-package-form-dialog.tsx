...
const fromDetail = (
  pkg: TourPackageDetail & Partial<FormState>
): FormState => ({
  ...emptyForm(),
  ...pkg,
...
export function TourPackageFormDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!h-[calc(100vh-32px)] !w-[calc(100vw-32px)] !max-w-none overflow-hidden rounded-2xl p-0 sm:!max-w-none">
              ...
              <section className={cardClass}>
                ...
                <div className="mt-5 grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      maxLength={200}
                      className="mt-2 min-h-[130px] w-full resize-y rounded-lg border border-slate-200 bg-white p-3 text-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
              ...
              <section className={`${cardClass} lg:col-span-2`}>
                ...
                <div className="mt-5 space-y-3">
                  {(form.itineraries || []).map((day, index) => (
                    <div
                      key={index}
                      className="grid grid-cols-[72px_minmax(0,1.4fr)_minmax(0,1fr)_minmax(0,1fr)_40px] items-center gap-3 rounded-lg border border-slate-100 bg-slate-50/60 p-2"
                    >
              ...
              <section className={cardClass}>
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      className={fieldClass}
                      placeholder="e.g. Hill Station, Family, Weekend"
