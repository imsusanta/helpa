...
function UsagePill({
  ...
  return (
    <div className="hidden h-10 items-center gap-2 px-3 whitespace-nowrap md:flex">
      <span
    ...
    <header className="z-20 flex h-[62px] shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-3 shadow-[0_1px_3px_rgba(15,23,42,0.04)] sm:px-4">
      ...
      <div className="relative min-w-0 flex-1 lg:max-w-[430px]">
        ...
        <input
          ...
          className="h-10 w-full rounded-xl border border-slate-200 bg-white pr-20 pl-9 text-sm font-medium text-slate-800 shadow-[0_1px_2px_rgba(15,23,42,0.04)] outline-none placeholder:text-slate-400 focus:border-slate-300 focus:ring-2 focus:ring-emerald-500/10"
        />
