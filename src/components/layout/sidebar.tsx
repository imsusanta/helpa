    ...
    <>
      ...
      >
        <div className="flex h-[76px] items-center justify-between px-5">
          ...
          <button
            type="button"
            className="rounded-lg p-1.5 text-slate-400 transition-all duration-200 hover:scale-105 hover:bg-white/5 hover:text-white active:scale-95 lg:hidden"
            onClick={onClose}
                      ...
                      {item.children.map((child, childIndex) => {
                        ...
                        return (
                          <Link
                            ...
                            className={cn(
                              'animate-sidebar-child relative flex h-8 items-center rounded-lg px-2.5 text-[13px] font-medium transition-all duration-200 ease-out hover:translate-x-1',
                              active
