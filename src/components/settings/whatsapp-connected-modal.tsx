    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="pointer-events-none absolute -bottom-24 -right-24 h-48 w-48 rounded-full bg-teal-500/20 blur-3xl" />
          ...
          <div className="mt-5 text-center space-y-1.5">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm">
              Your device has been paired successfully and is ready to automate conversations.
            </p>
          </div>
          ...
          <div className="border-border/80 bg-muted/30 mt-6 space-y-3 rounded-2xl border p-4">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                className="border-emerald-500/40 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 gap-1 text-xs font-semibold"
              >
          ...
          <div className="mt-6 flex flex-col-reverse gap-2.5 sm:flex-row sm:items-center sm:justify-end">
            <Button
              variant="outline"
              onClick={onClose}
              className="border-border text-foreground font-semibold text-xs sm:w-auto"
            >
              Done
            </Button>
            <Link href="/inbox" className="w-full sm:w-auto">
              <Button
                onClick={onClose}
                className="w-full gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 font-bold text-white shadow-md hover:from-emerald-700 hover:to-teal-700 text-xs sm:text-sm"
              >
