  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#FBFAFD] via-[#F8F6FD] to-[#F1EEFA] pt-28 pb-8 sm:pt-32">
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute top-28 left-1/2 h-[520px] w-[760px] -translate-x-1/2 rounded-full bg-[#DCD5FF]/25 blur-3xl" />
        <div className="absolute top-32 left-0 h-64 w-64 rounded-full bg-white/70 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1120px] text-center">
          ...
          <h1 className="mx-auto max-w-[1050px] text-[54px] leading-[0.98] font-black tracking-[-0.045em] text-[#110E3D] sm:text-[64px] lg:text-[76px]">
            Automate WhatsApp.
            <br />
            Get{' '}
          ...
          <p className="mx-auto mt-7 max-w-[760px] text-base leading-8 text-[#5C587D] sm:text-lg lg:text-[19px]">
            ...
            customers,
            <br className="hidden sm:block" /> follows up automatically, and
            helps you turn conversations into sales.
          </p>
          ...
          <div className="mb-5 flex items-center justify-center gap-5 border-b border-slate-200/80 pb-2 sm:gap-10">
            {tabs.map(({ icon: Icon, label }, index) => (
              <button
                key={label}
                type="button"
                className={`flex items-center gap-2 border-b-2 px-3 pt-2 pb-3 text-sm font-bold sm:px-4 sm:text-base ${
                  index === 0
              ...
              <div className="flex min-h-[440px] flex-col px-4 py-4 sm:px-6">
                ...
                <div className="flex flex-1 flex-col justify-end gap-3 py-4">
                  <div className="max-w-[78%] rounded-2xl rounded-tl-sm bg-slate-100 px-4 py-3 text-xs leading-relaxed text-slate-800">
                    Hi, I found your business on WhatsApp. Can you tell me more
                    about your service?
                  ...
                  <div className="ml-auto max-w-[82%] rounded-2xl rounded-tr-sm bg-[#DCF8C6] px-4 py-3 text-xs leading-relaxed text-slate-900 shadow-sm">
                    Absolutely! 👋 I can help with pricing, availability,
                    services, and next steps. What would you like to know?
                    <div className="mt-1 text-right text-[9px] text-slate-400">
                      10:14 AM ✓✓
                    </div>
                  </div>
                  <div className="max-w-[42%] rounded-2xl rounded-tl-sm bg-slate-100 px-4 py-3 text-xs text-slate-800">
                  ...
                  <div className="ml-auto max-w-[78%] rounded-2xl rounded-tr-sm bg-[#DCF8C6] px-4 py-3 text-xs leading-relaxed text-slate-900 shadow-sm">
                    I can share the right option based on what you need. Would
                    you like a quick consultation?
                    <div className="mt-1 text-right text-[9px] text-slate-400">
                      10:15 AM ✓✓
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2 border-t border-slate-100 pt-3">
                  <div className="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-xs text-slate-400">
                    Type a message to test AI assistant...
                  </div>
              ...
              <div className="border-t border-slate-100 p-4 lg:border-t-0 lg:border-l">
                ...
                <div className="mt-3 space-y-2 text-xs">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold">Product enquiry</span>
                  </div>
                  <div className="flex items-center justify-between">
