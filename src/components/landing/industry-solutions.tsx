...
const FEATURES = [
  {
    ...
    description:
      'Answer common questions, capture enquiries, and keep every WhatsApp conversation moving.',
  },
  {
    icon: CalendarCheck,
    title: 'Book Appointments',
    description:
      'Let customers check availability and book, reschedule, or cancel without back-and-forth.',
  },
  {
    icon: UsersRound,
    title: 'Manage Customers',
    description:
      'Keep contacts, conversation history, follow-ups, and customer details together in one place.',
  },
  {
    icon: BarChart3,
    title: 'Grow Your Business',
    description:
      'Qualify leads, organize opportunities, and help your team follow up faster.',
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_2fr]">
          <div className="max-w-md">
            <div className="mb-4 flex items-center gap-2 text-xs font-bold tracking-[0.18em] text-emerald-600 uppercase">
            ...
            <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
              From conversations to conversions — automate routine work so your
              team can focus on customers and growth.
            </p>
            <Link
              href="/signup"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {FEATURES.map(({ icon: Icon, title, description }) => (
              ...
              >
                ...
                <h3 className="mt-7 text-lg font-bold text-[#110E3D]">
                  {title}
                </h3>
