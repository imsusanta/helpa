      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="mt-3 text-base text-slate-600">
            Setup and monthly software fees are shown separately. Meta messaging
            charges and taxes may apply.
          </p>
        </div>
          ...
          {plans.map((plan) => {
            ...
            return (
              <article
                ...
                className={`relative flex flex-col justify-between rounded-3xl p-6 ${recommended ? 'scale-[1.02] border-2 border-emerald-500 bg-[#110E3D] text-white shadow-2xl' : 'border border-slate-200 bg-white text-slate-900 shadow-sm'}`}
              >
                {recommended && (
                  <div className="absolute -top-3.5 left-1/2 flex -translate-x-1/2 items-center gap-1 rounded-full bg-gradient-to-r from-[#C4F135] to-[#4EE3C2] px-3.5 py-1 text-[10px] font-extrabold tracking-wider text-[#110E3D] uppercase">
