 ...
 *
 * These mirror the schema added in migration 010 (`flows`,
 ...
 * storage bucket by the builder; `media_url` is the public
...
// ============================================================
// DB-row shapes (read by the engine via getAdminClient)
// ============================================================
