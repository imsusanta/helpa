...
| --- | -------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | appwrite-sites deployment returns `DEPLOYMENT_NOT_FOUND`                                                 | P0       | Centralize environment validation, add `GET /api/health`, document appwrite-sites/Node.js deployment in `docs/DEPLOYMENT.md`                    |
...
3. Include transparent attribution:
   _"Helpa is based on the MIT-licensed wacrm project by ArnasDon and includes Helpa-specific healthcare workflows, AI receptionist functionality, security hardening, and operational extensions."_
